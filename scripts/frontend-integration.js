 ...
 * This file demonstrates how to integrate Quillveil with a web frontend
 */

// For React/Vue/Angular applications
export class QuillveilClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new QuillveilClient(provider, contractAddress);
